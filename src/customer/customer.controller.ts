...
export class CustomerController {
  ...
  async addCustomer(@Res() res, @Body() createCustomerDTO: CreateCustomerDTO) {
    ...
    return res
      ...
      .json({ message: 'Customer has been successfully created!', customer });
  }

  // Get all customers from db list
  @Get('customers')
  ...
  async updateCustomer(
    ...
    return res
      .status(HttpStatus.OK)
      .json({ message: 'Customer has been successfully updated!', customer });
  }
  ...
  async deleteCustomer(@Res() res, @Query('customerID') customerID) {
    ...
    return res
      .status(HttpStatus.OK)
      .json({ message: 'Customer has been deleted', customer });
  }
}
